      ...
      <div className="grid gap-6 md:grid-cols-2">
        <div className="rounded-2xl border border-slate-200/80 bg-white/80 p-6 shadow-sm dark:border-slate-800/60 dark:bg-slate-900/70">
          ...
          <p className="text-sm text-slate-600 dark:text-slate-300">
            برای ثبت تیکت جدید، از منوی سمت راست گزینه "ثبت تیکت جدید" را انتخاب
            کنید، موضوع و توضیحات خود را وارد کنید و روی دکمه ارسال کلیک کنید.
          </p>
        </div>
        ...
        <div className="rounded-2xl border border-slate-200/80 bg-white/80 p-6 shadow-sm dark:border-slate-800/60 dark:bg-slate-900/70">
          ...
          <p className="text-sm text-slate-600 dark:text-slate-300">
            در داشبورد اصلی، لیست تمام تیکت‌های شما نمایش داده می‌شود. با کلیک
            بر روی هر تیکت می‌توانید جزئیات و پیام‌های آن را مشاهده کنید.
          </p>
        </div>
        ...
        <div className="rounded-2xl border border-slate-200/80 bg-white/80 p-6 shadow-sm dark:border-slate-800/60 dark:bg-slate-900/70">
          ...
          <p className="text-sm text-slate-600 dark:text-slate-300">
            با ورود به جزئیات تیکت، می‌توانید در قسمت پایین صفحه پیام خود را
            تایپ کرده و ارسال کنید. تیم پشتیبانی به زودی به شما پاسخ خواهد داد.
          </p>
        </div>
